...
Snake.prototype.update = function () {
    ...
    if (this.body[0].col > game.col - 1 || this.body[0].col < 0 || this.body[0].row > game.row - 1 || this.body[0].row < 0) {
        ...
        alert(' Congratulations, you identified '+ game.score+' pieces of true news and '+ game.fakeScore+' pieces of fake news. Keep up the good work.');
